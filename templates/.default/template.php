...
<div id="animation_container" style="position: absolute; top: 0; left: 0; width:1280px; height:720px; z-index: -1; <?if(empty($arRes["data"])){?> display: none<?}?>">
  ...
  <a href="#" class="previous" id="previous" style="position:absolute; top: 75%; left: 42%; z-index: 99999; color: #c9aa30; font-size: 32px;" onclick="fnc_previous()"></a>
  <div id="page_and_page" style="color: #c9aa30;font-size: 32px;position:absolute;top: 75%; left: 44%; z-index: 99999;"></div>
  <a href="#" class="next" id="next" style="position:absolute; top: 75%; left: 48%; z-index: 99999; color: #c9aa30; font-size: 32px;" onclick="fnc_next()"></a>
  <a href="#" id="blog-<?=$uid?>-mark_as_read" style="position:absolute; top: 76%; left:62%; z-index: 99999;" onclick="fnc_mark_as_book()"></a>
</div>
      ...
      complete:function(){
        ...
        var easing_2 = new BX.easing({
          ...
          complete:function(){
            ...
            easing_3.animate()
>>>>>>> 53a9b525c731c2abf4f6f2ea416264799b9701b7
          }
        }else{
          setTimeout(function(){
            chk = 1;
